  ...
  return (
    <div className="fixed bottom-8 right-8 z-50 flex flex-col items-end gap-3">
      ...
      >
        ...
        >
          <motion.div
            className="relative bg-[#25D366] text-white w-14 h-14 rounded-full shadow-2xl hover:shadow-green-500/50 flex items-center justify-center transition-all overflow-hidden"
