...
const WEB_PROJECTS = [
  {
    ...
    subtitle: "Model & talent casting platform for Mauritius and beyond",
    client: "ModelManagement.mu",
    description:
      "A regional gateway into the global ModelManagement network, connecting Mauritian and African models with photographers, brands, and agencies. Includes profile management, casting tools, and safer collaboration workflows for both newcomers and professionals.",
    tags: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Firebase"],
    year: "2024",
    image: "/pro/model.jpg",
    link: "https://modelmanagement.mu",
    features: [
      "Model and talent profile onboarding tailored to the Mauritian market",
      "Casting and shortlisting tools for local and international clients",
      "Portfolio and media management for models and creators",
      "Search and discovery flows aligned with global ModelManagement standards",
    ],
  },
  {
    slug: "flash-communication",
    title: "Flash Communications",
    subtitle: "Integrated creative, digital, OOH, video & events studio",
    client: "theflashgroups.com",
    description:
      "A modern web presence for a full-service communication agency in Mauritius, showcasing services across digital campaigns, outdoor advertising, video production, and event activations under the Flash Groups brand.",
    tags: ["HTML", "CSS", "JS", "CMS", "SEO"],
    year: "2024",
    image: "/pro/flash.jpg",
    link: "https://theflashgroups.com",
    features: [
      "Interactive portfolio to highlight multi-channel campaigns",
...
const ECOMMERCE_PROJECTS = [
  ...
  },
  {
    ...
    description:
      "A B2B and retail ordering platform for a leading IT and electronics distributor in the Indian Ocean region, enabling partners to browse catalogues, place bulk orders, and manage repeats for global hardware brands.",
    tags: ["WooCommerce", "WordPress", "B2B", "Custom Checkout"],
    image: "/pro/sd.jpg",
    features: [
      "Separate catalogues and pricing logic for B2B partners and retail buyers",
      "Bulk ordering flows with tiered price breaks",
      "Customised checkout with invoicing and purchase-order support",
      "Stock status and product detail views tuned for IT hardware",
    ],
  },
  {
